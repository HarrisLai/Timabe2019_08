...
-- 資料庫: `python_ai_2018`
--
CREATE DATABASE `python_ai_2018` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `python_ai_2018`;
...
--
-- 資料表的 Constraints `tel`
--
ALTER TABLE `tel`
  ADD CONSTRAINT `tel_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
